...
There are two terminal pins and one wiper(pin in middle). Terminals are when connected to Vcc and GND (in any manner), output at the wiper will change depending upon rotation of shaft.
